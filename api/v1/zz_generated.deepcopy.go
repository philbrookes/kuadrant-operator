...
func (in *DNSPolicySpec) DeepCopyInto(out *DNSPolicySpec) {
	*out = *in
	...
	in.Unpublish.DeepCopyInto(&out.Unpublish)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Unpublish) DeepCopyInto(out *Unpublish) {
	*out = *in
	if in.When != nil {
		in, out := &in.When, &out.When
		*out = make(Rules, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Unpublish.
func (in *Unpublish) DeepCopy() *Unpublish {
	if in == nil {
		return nil
	}
	out := new(Unpublish)
